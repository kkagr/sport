...
<style type="text/css">
body{margin:0;padding:0;font-size:12px;background:url(${request.getcontextpath()}/res/jeecms/img/login/bg.jpg) top repeat-x;}
    ...
    <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
          <td width="423" height="280" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr>
                <td><img src="${request.getcontextpath()}/res/jeecms/img/login/ltop.jpg" /></td>
              </tr>
              <tr>
                <td><img src="${request.getcontextpath()}/res/jeecms/img/login/llogo.jpg" /></td>
              </tr>
            </table></td>
          <td width="40" align="center" valign="bottom"><img src="${request.getcontextpath()}/res/jeecms/img/login/line.jpg" width="23" height="232" /></td>
          <td valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr>
                <td height="90" align="center" valign="bottom"><img src="${request.getcontextpath()}/res/jeecms/img/login/ltitle.jpg" /></td>
              </tr>
              <tr>
                <td>
                <div>
<#if errors??>
	...
	<#list errors as error><li>${error}</li></#list>
                ...
                <table width="100%" border="0" align="center" cellpadding="0" cellspacing="5">
                    ...
                    <tr>
                    	<td colspan="2" align="center"><img src="${request.getcontextpath()}/captcha.svl" onclick="this.src='${request.getcontextpath()}/captcha.svl?d='+new Date()*1"/></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                      <td height="40" colspan="2" align="center">
					    <input type="image" src="${request.getcontextpath()}/res/jeecms/img/login/login.jpg" name="submit" />
                        &nbsp; &nbsp; <img name="reg" style="cursor: pointer" src="${request.getcontextpath()}/res/jeecms/img/login/reset.jpg" onclick="document.forms[0].reset()" /> </td>
                    </tr>
                  </table></td>
              </tr>
            </table></td>
